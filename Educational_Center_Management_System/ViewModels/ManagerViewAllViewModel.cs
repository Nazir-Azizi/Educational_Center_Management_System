...
{
    public class ManagerViewAllViewModel : BaseViewModel
    {
        ...
        public ICommand ShowAllMembers { get; set; }
        public ManagerViewAllViewModel()
        {
            ShowAllMembers = new RelayCommand(ExecuteShowAllMembers);
        }
        private void ExecuteShowAllMembers(object? parameter)
        {
            ...
            {
                CurrentViewModel = new ManagerAllTeachersViewModel();
            }
        }
    }
}
